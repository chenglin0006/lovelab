...
var current = new Date('2016-12-01');//以2016-12-01为日历的开始时间
...
module.exports = {
    ...
    //页面滚动至选中日期
    toActiveDayIndex: function(num,type){
        var classStrActive = "."+type+" .v-calendar--date-day-wrapper.is-active";
        var classStrToday = "."+type+" .v-calendar--date-day-wrapper.today";
        var classStrTo = "."+type+" .v-calendar--date";
