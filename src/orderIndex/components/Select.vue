...
<template>
    <div class="dropdown v-select" :class="dropdownClasses">
        ...
        <span class="selected-tag" v-for="option in valueAsArray" v-bind:key="option.index">
          ...
          <button v-if="multiple" @click="deselect(option)" type="button" class="close">
            ...
            <input
                    ...
                    @focus="setAppHeight"
            >
            <span class="cancel-btn" v-show="showCancelBtn" @click="clearSearch"></span>
        ...
        <ul ref="dropdownMenu" :transition="transition" class="dropdown-menu" :style="{ 'max-height': maxHeight }">
            <li v-for="(option, index) in filteredOptions" v-bind:key="index" :class="{ active: isOptionSelected(option)}" @click.prevent="select(option)">
